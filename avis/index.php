...
if(isset($_POST['envoyer'])) {
    ...
    extract($_POST);
        ...
        if ($req) {
            ...
            // en-têtes expéditeur
            $entetes .= "From : ne-pas-repondre@willodemenagement.fr\n";
	...
	<div class="row add_bottom_30">
        ...
        <div class="review_desc">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="media">
                	<img src="img/avatar/<?= $avis['avatar']; ?>.png" width="60" height="60" alt="Avatar" class="pull-left">
...
<div class="row">
	...
	<div class="col-md-4" id="contact">
		...
		<ul>
			<li><i class="icon-home"></i> 45 avenue Jean Monnet, 33700 Mérignac </li>
