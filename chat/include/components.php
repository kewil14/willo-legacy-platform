 ...
 * ==========================================================
 *
 * Bibliothèque de composants HTML statiques pour la zone d'administration. Ce fichier ne doit pas être exécuté directement. � 2023-2024 RAD. Tous les droits sont réservés.
 *
 */
        ...
        <div class="sb-header">
            ...
            <div class="sb-admin-nav-right sb-menu-mobile">
                ...
                <div class="sb-desktop">
                    ...
                    <?php if ($is_admin && (!$is_cloud || defined('SB_CLOUD_DOCS'))) echo '<a href="' . ($is_cloud ? SB_CLOUD_DOCS : 'https://raddev.fr') . '" target="_blank" class="sb-docs"><i class="sb-icon-help"></i></a><a href="#" class="sb-version">' . SB_VERSION . '</a>' ?>
                </div>
                <div class="sb-mobile">
