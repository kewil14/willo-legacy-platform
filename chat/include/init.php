        ...
        echo '<div class="sb-profiles">' . $code . '</div>';
            ...
            <div class="sb-dashboard">
                <div class="sb-dashboard-conversations">
                    <div class="sb-title">
                        Développé par <a href="https://raddev.fr" target="_blank">RAD</a><br/>
...
function sb_messaging_channels() {
    $channels = [['wa', 'WhatsApp', 'whatsapp'], ['fb', 'Messenger'], ['ig', 'Instagram'], ['tw', 'Twitter'], ['tg', 'Telegram'], ['vb', 'Viber'], ['ln', 'LINE'], ['em', 'Email'], ['tk', 'Ticket']];
