...
class Count_visitors {
	...
	function insert_new_visit() {
        ...
        $insert_sql = "INSERT INTO {$this->table_name} (id, ip_adr, client, visit_date, time, on_page) VALUES (NULL, :remote_addr, :client, CURDATE(), CURTIME(), :on_page)";
	...
	function show_visits_today() {
        ...
        $res_today = $pdo->query("SELECT COUNT(*) AS count FROM {$this->table_name} WHERE visit_date = CURDATE()");
