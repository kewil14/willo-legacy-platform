...
// niet vergeten visits ouder dan een jaar te verwijderen
    ...
    function insert_new_visit() {
        ...
        $liste_ip=array('2a01:cb18:a79:8','2a01:e0a:517:59','10.5.33.2','88.124.93.101','2a01:cb1a:4051:','2a01:cb19:3f:6c');
        ...
        $insert_sql = "INSERT INTO {$this->table_name} (id, ip_adr, client, visit_date, time, on_page) VALUES (NULL, :remote_addr, :client, CURDATE(), CURTIME(), :on_page) WHERE :remote_addr NOT IN ($liste_ip_str)";
    ...
    function show_all_visits() {
       ...
       /* $liste_ip = array('2a01:cb18:a79:8','2a01:e0a:517:59','10.5.33.2','88.124.93.101','2a01:cb19:3f:6c','2a01:cb19:3f:6c00:24d8:ff8b:22b3:811b',
            '2a01:cb1a:4051:40fc:4cc6:db85:4777:9344','2a01:cb01:3020:f5e5:3f68:5a2a:622e:f23b','2a01:cb19:3f:6c00:25b3:d216:a156:1497','2a01:cb19:3f:6c00:5a1:aea1:45d1:909d');
        $liste_ip_str ="";
...
*/
        ...
        $result = $pdo->query("SELECT COUNT(*) AS count FROM {$this->table_name}  ");
    ...
    function show_visits_today() {
        ...
        $res_today = $pdo->query("SELECT COUNT(*) AS count FROM {$this->table_name} WHERE visit_date = CURDATE() and ip_adr NOT IN ($liste_ip_str)");
